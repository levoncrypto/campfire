...
class _TransactionV2DetailsViewState
    ...
    try {
      if (Util.isDesktop) {
        ...
        unawaited(
          Navigator.of(
            context,
          ).pushNamed(BoostTransactionView.routeName, arguments: _transaction),
        );
      }
    } finally {
  ...
  void initState() {
    ...
    if (_transaction.type
      ...
      supportsRbf =
          _transaction.subType == TransactionSubType.none &&
  ...
  Widget build(BuildContext context) {
    ...
    final detailStyle = Util.isDesktop
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                builder: (context) {
                                  ...
                                  if (widget.coin is Bitcoincash ||
                                    ...
                                    if (widget.coin is! Epiccash && confirmed) {
                                      height =
                                          "${_transaction.height == 0 ? "Unknow"
                                                    "n" : _transaction.height}";
                                    } else {
                                      height = confirms > 0
                                          ? "${_transaction.height}"
                                          : "Pending";
                              ...
                              if (coin is Salvium &&
                                ...
                                _DetailItem(
                                  label: "Type",
                                  detail: _transaction.salviumTypeString!,
                                  vertical: true,
                                ),
                              if (kDebugMode)
                                isDesktop
                              ...
                              if (kDebugMode)
                                _DetailItem(
                                  label: "Tx sub type",
                                  detail: _transaction.subType.toString(),
                                ),
                                    ...
                                    children: [
                                      Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          Text("Slate ID", style: labelStyle),
                                          // Flexible(
                                          //   child: FittedBox(
                                          //     fit: BoxFit.scaleDown,
                                          //     child:
                      ...
                      if (wallet is EpiccashWallet) {
                        ...
                        unawaited(
                          showFloatingFlushBar(
                            type: FlushBarType.warning,
                            message:
                                "ERROR: Wallet type is not "
                                "Epic Cash or MimbleWimbleCoin",
                            context: context,
                          ),
                        );
                        return;
...
class IconCopyButton extends StatelessWidget {
  const IconCopyButton({super.key, required this.data});
...
class IconPencilButton extends StatelessWidget {
  const IconPencilButton({super.key, this.onPressed});
...
class _DetailItemBase extends StatelessWidget {
  const _DetailItemBase({
    // super.key,
    required this.child,
  });
...
class _DetailItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _DetailItemBase(
      child: vertical
          ? Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(children: [Text(label, style: labelStyle)]),
                const SizedBox(height: 8),
...
class _TxidDetailItem extends ConsumerStatefulWidget {
  const _TxidDetailItem({
    // super.key,
    required this.coin,
    required this.txid,
  ...
  @override
  ConsumerState<_TxidDetailItem> createState() => _TxidDetailItemState();
}

class _TxidDetailItemState extends ConsumerState<_TxidDetailItem> {
  Future<bool> showExplorerWarning(String explorer) async {
    final warningMessage =
        ...
        "transaction. Only proceed if you trust $explorer.";
  ...
  Widget build(BuildContext context) {
    ...
    return _DetailItemBase(
      child:
          widget.txid.startsWith("mweb_outputId_") &&
              widget.subType == TransactionSubType.mweb
          ? Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      SelectableText(
                        widget.txid.replaceFirst("mweb_outputId_", ""),
                        style: isDesktop
                            ? STextStyles.desktopTextExtraExtraSmall(
                                context,
                              ).copyWith(
                ...
                if (isDesktop)
                  IconCopyButton(
                    data: widget.txid.replaceFirst("mweb_outputId_", ""),
                  ),
              ],
            )
          : Row(
                    ...
                    children: [
                      ConditionalParent(
                        ...
                        builder: (child) => Row(
                          children: [
                            Expanded(child: child),
                            SimpleCopyButton(data: widget.txid),
                          ],
                        ),
                        child: Text(
                          "Transaction ID",
